...
phonological_profiles <- read_csv("ejective_and_n_consonants.csv")
...
phonological_profiles <- as.data.frame(phonological_profiles)
save(phonological_profiles, file="phonological_profiles.RData", compress='xz')
