...
#' @seealso \code{\link{abvd.feature}}, \code{\link{afbo.feature}}, \code{\link{autotyp.feature}}, \code{\link{oto_mangueanIC.feature}}, \code{\link{sails.feature}}, \code{\link{valpal.feature}}, \code{\link{wals.feature}}
#' @examples
#' # phoible.feature()
...
@book{phoible,
 ...
 year      = {2014}
    ...
    if (sum(!features %in% features_set) < 1) {
      final_df <-
        utils::read.csv(
          "https://raw.githubusercontent.com/clld/phoible/master/data/phoible-aggregated.tsv",
          sep = "\t",
      ...
      final_df$language <-
        lingtypology::lang.iso(final_df$LanguageCode,
