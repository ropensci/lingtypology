...
#' @seealso \code{\link{autotyp.feature}}, \code{\link{phoible.feature}}, \code{\link{sails.feature}}, \code{\link{valpal.feature}}, \code{\link{wals.feature}}
#' @examples
...
Feist, Timothy & Enrique L. Palancar. 2015. Oto-Manguean Inflectional Class Database. University of Surrey. http://dx.doi.org/10.15126/SMG.28/1")
  temp1 <- tempfile()
  utils::download.file("http://www.oto-manguean.surrey.ac.uk/Database/Export", destfile = temp1)
