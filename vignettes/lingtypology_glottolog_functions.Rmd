...
This package is based on the [Glottolog database (v. 4.1)](http://glottolog.org/), so `lingtypology` has several functions for accessing data from that database.
