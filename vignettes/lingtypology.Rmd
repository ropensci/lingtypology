...
It is possible to add a minimap to a map. Users can control its appearance (set `minimap` argument to TRUE or FALSE) and its position (use `minimap.position` argument values "topright", "bottomright", "bottomleft" or "topleft").
```{r, fig.width=6.2}
set.seed(42)
map.feature(c("Adyghe", "Polish", "Kabardian", "Russian"),
            minimap = TRUE,
