...
* Abkhazian is changed to Abkhaz. Abkhazian, Abaza, Georgian, Ossetian, Archi and Ingush coordinates are changed. (22.01.2017)
...
More ditailed information about how our database was created can be seen from [GitHub folder](https://github.com/agricolamz/lingtypology/tree/master/database_creation).
...
### 3.14 Add a kernal density estimation plot to a map
Sometimes it is easear to look at kernal density estimation plot. It can be created using `density.estimation` argument:
```{r, fig.width=6.2, fig.height=3.4}
map.feature(circassian$language,
            longitude = circassian$longitude,
            latitude = circassian$latitude,
