...
* Northern Sahaptin names corrected. Central Guerrero Nahuatl is renamed Guerrero Nahuatl (thanks to Timo Roettger for mentioning that problems).
...
If for some reasons you are not using RStudio or you want automatically create and save a lot of maps, you can save a map to the variable and use `htmlwidgets` package for saving created maps to an .html file.[^2]
[^2]: I would like to thank Timo Roettger for mentioning that problem.
