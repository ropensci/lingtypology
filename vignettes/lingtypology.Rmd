...
Pictures are on the map, but they are too small...
```{r, fig.width=6.2}
df <- data.frame(lang = c("Russian", "Russian"),
                 lat  = c(55.75, 59.95),
                 long = c(37.616667, 30.3),
...
Using this argument users can plot their own markers, any chart connected to the point or even their own legend.
